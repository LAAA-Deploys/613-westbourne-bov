...
Win-the-listing pitch for Ian Lee & family. Full standard BOV: track record ->
...
<style>
  ...
  *{ box-sizing:border-box; margin:0; padding:0; }
  ...
  .bigprice{ font-size:62px; font-weight:800; color:var(--navy); line-height:1; letter-spacing:-.02em; }
  ...
  .trade .px{ font-size:32px; font-weight:800; color:#fff; margin-top:10px; }
...
<div class="prepared">The most qualified team to price and sell an 8-unit apartment building in an A-level Los Angeles location.</div>
...
<section id="intro">
  <div class="wrap">
    ...
    <p class="lead" style="margin-top:20px;max-width:820px">For over a decade, the only thing we have sold is apartment buildings in Los Angeles, and our strongest markets are the A-level Westside cities like West Hollywood, Beverly Hills, and Santa Monica. Since 2018, no team has sold more apartment buildings in the 5 to 25-unit range in Los Angeles than we have.</p>
    <p style="max-width:820px">This presentation walks through exactly what you would expect from a professional broker opinion of value: who we are and what we have closed on your doorstep, how we read the West Hollywood market today, the marketing machine we will run, the most relevant recent sale and rent comparables, a full financial analysis of your building, and our recommended pricing: the estimated value, the trade range, and the price we would list at. The number is at the end, where it belongs, supported by everything that comes before it.</p>
  </div>
</section>
...
<section id="team" class="alt">
  <div class="wrap">
    ...
    <h2 style="font-size:30px;margin-bottom:8px">Two senior partners, not a junior hand-off</h2>
...
<section id="resume">
  <div class="wrap">
    ...
    <p style="max-width:820px;margin-top:14px">This is not a brag. It is the single most important qualification for selling your building. We price apartment buildings every single day, we know who the buyers are, and we know how to run the process. The numbers below are our firm-wide career record.</p>
    ...
    <p style="max-width:820px;margin-top:8px">Our closed transactions are concentrated in exactly the markets that matter for your building: the prime, supply-constrained Westside cities. Here is a snapshot of our closings in these submarkets.</p>
    ...
    <div class="callout">
      ...
      <h3>We closed a building on North Genesee, the same block as one of your strongest recent comps</h3>
      <p>In January 2025 we closed 1046 N Genesee Ave in prime West Hollywood. That is the same block as 1036 N Genesee, which traded in April 2026 at $2,850,000 and is one of the most relevant comparables in this report. When we tell you what 613 Westbourne is worth, it comes from deals we actually close in your neighborhood, not a database guess.</p>
    </div>
  </div>
</section>
...
<section id="marketing" class="alt">
  <div class="wrap">
    ...
    <h2 style="font-size:32px;max-width:820px">How we put 613 Westbourne in front of every qualified buyer, at the same time</h2>
    ...
    <div class="feat" style="margin-top:26px">
      <div class="f"><h4><span class="ico">&#9742;</span> The right people, by name</h4><p>The most probable buyer owns a similar building nearby. We have the first name, last name, cell phone, and email, confirmed, for essentially every apartment owner in West Hollywood, with roughly 95% accuracy. A full-time analyst keeps the database current on every LA County apartment sale.</p></div>
...
<section id="details" class="alt">
  <div class="wrap">
    ...
    <p class="maptip" style="margin-top:18px">Unit count, square footage, and unit mix should be confirmed against the rent roll and title before any client-facing claim. Figures above reflect the current pricing model.</p>
  </div>
</section>
    ...
    <div class="twocol" style="margin-top:30px">
      <div>
        ...
        <ul class="clean">
          ...
          <li><strong>Investor-driven buyer pool</strong>: the WeHo buyer is buying income and location, and we know precisely who they are.</li>
        </ul>
      </div>
      <div class="demo">
...
<section id="buyer">
  <div class="wrap">
    <div class="eyebrow">The Buyer</div>
    <h2 style="font-size:30px;max-width:820px">Who buys 613 Westbourne, and how we handle their objections</h2>
    <p class="lead" style="margin-top:14px;max-width:840px">The most likely buyer is a private-capital investor or 1031 exchange buyer who already owns on the Westside and wants a well-located, manageable building in a city that holds value. We know these buyers by name. Here is what they will push on, and how we answer it before it becomes a retrade.</p>
    <div class="feat" style="margin-top:24px">
...
<section id="comps" class="alt">
  <div class="wrap">
    <div class="eyebrow">Sale Comparables</div>
...
<section id="rentcomps">
  <div class="wrap">
    <div class="eyebrow">Rent Comparables</div>
...
<section id="pricing">
  <div class="wrap">
    ...
    <p style="max-width:880px">This is an investment sale, not a home sale. The buyer is solving for return: price per unit, price per square foot, cap rate, GRM, and cash-on-cash at today's low-6% interest rates. We value your building against the right comps: rent-controlled, pre-1978, comparable size, and the most recent sales possible, because the market has moved.</p>
  ...
  <div class="wrap">
    ...
    <div class="twocol" style="margin-top:26px">
      <div>
        ...
        <p>Terms matter as much as price in a 1031. We ask every buyer a simple question: why do you want to buy it? And we almost always know the buyer or broker and their reputation. You will get our honest read on whether they will actually close.</p>
      </div>
      <div>
        <div class="demo">
